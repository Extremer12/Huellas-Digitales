...
const ComoAyudarSection = () => {
  ...
  const handleCopyAlias = async () => {
    try {
      await navigator.clipboard.writeText("zioncode");
      setCopied(true);
      toast({
        title: "¡Alias copiado!",
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6 py-4">
          <div className="bg-card/50 rounded-2xl p-6 border border-primary/20">
            <p className="text-sm text-muted-foreground mb-3">Alias de MercadoPago:</p>
            <div className="flex items-center justify-between gap-3 bg-background/50 rounded-xl p-4">
              <span className="text-2xl font-bold text-primary">zioncode</span>
              <Button
